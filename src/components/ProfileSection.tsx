...
export default function ProfileSection() {
  ...
  return (
    <section className="bg-[var(--card)] text-[var(--text)] min-h-screen flex items-center justify-center">
        <div className="max-w-6xl w-full flex flex-col md:flex-row items-center md:items-start gap-8 px-6 py-12">
            <div className="flex-2 text-center md:text-left">
                ...
                <h1 className="text-4xl sm:text-5xl font-extrabold text-[var(--text)]">
                    {t('Juan M. López Durán')}
                </h1>
                <h2 className="text-xl mt-2 font-semibold text-[color:var(--muted)]">
                ...
                <div className="mt-6 flex flex-wrap justify-center md:justify-start gap-4">
                    <button className="bg-blue-500 hover:bg-blue-600 text-[var(--text)] px-6 py-2 rounded-md font-semibold">
                        {t('Get in Touch')}
                    </button>
                    <button className="border border-gray-500 hover:border-gray-300 text-[var(--text)] px-6 py-2 rounded-md font-semibold">
                        {t('View My Work')}
                    </button>
                </div>

                <div className="mt-6 flex justify-center md:justify-start gap-4">
                    <a href="#" className="text-blue-400 hover:text-[var(--text)]">
